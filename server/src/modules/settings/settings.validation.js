...
export const updateSettingsSchema = z.object({
  body: z.object({
    ...
    invoiceDefaultCgstPercent: z.coerce.number().min(0).max(100).optional(),
    invoiceDefaultSgstPercent: z.coerce.number().min(0).max(100).optional(),
    invoiceDefaultIgstPercent: z.coerce.number().min(0).max(100).optional(),
