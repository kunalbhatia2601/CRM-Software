...
class SettingsService {
  ...
  async getInvoiceConfig() {
    ...
    return {
      ...
      invoiceDefaultCgstPercent: Number(s.invoiceDefaultCgstPercent ?? 0),
      invoiceDefaultSgstPercent: Number(s.invoiceDefaultSgstPercent ?? 0),
      invoiceDefaultIgstPercent: Number(s.invoiceDefaultIgstPercent ?? 0),
