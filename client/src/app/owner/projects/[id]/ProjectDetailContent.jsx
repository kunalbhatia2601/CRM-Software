...
export default function ProjectDetailContent({ initialProject, initialMeetings = [], initialDocuments = [], initialSteps = [], initialTasks = [], initialMilestones = [], assignableUsers = [] }) {
  ...
  // Delivery on one side, campaign performance on the other.
  ...
  return (
    <div className="flex flex-col gap-6 w-full">
      ...
      {/* ═══ Invoices ═══ */}
      <ProjectInvoicesSection projectId={project.id} basePath="/owner" />

      <ProjectExpensesSection projectId={project.id} basePath="/owner" />
