  ...
  return (
    <div className="flex flex-col gap-6 w-full">
        ...
        <div className="px-8 pb-8 -mt-12 relative">
          <div className="flex flex-col md:flex-row gap-6 items-start">
            <div className="w-24 h-24 rounded-2xl bg-gradient-to-br from-white to-slate-50 border-4 border-white shadow-xl flex items-center justify-center">
              <StageIcon className="w-10 h-10 text-slate-600" />
            </div>
            <div className="flex-1 pt-4">
              ...
              <p className="text-sm text-slate-500 mb-4">
                From lead: <span className="font-medium text-slate-700">{deal.lead?.companyName}</span>
      ...
      <div className="bg-white rounded-[24px] p-6 lg:p-8 border border-slate-100 shadow-sm shadow-slate-200/50">
        <h3 className="text-lg font-bold text-slate-900 mb-6">Deal Pipeline</h3>
        ...
        {deal.stage === "LOST" && (
          <div className="mt-4 flex items-center gap-2 text-sm">
            <Badge value="LOST" />
            <span className="text-slate-500">— This deal is not in the active pipeline.</span>
          </div>
        )}
      </div>
      ...
      {allowedTransitions.length > 0 && (
        <div className="bg-white rounded-[24px] p-6 lg:p-8 border border-slate-100 shadow-sm shadow-slate-200/50">
          <h3 className="text-lg font-bold text-slate-900 mb-2">Update Stage</h3>
          <p className="text-sm text-slate-500 mb-6">Move this deal forward or mark it as lost.</p>
          <div className="flex flex-wrap gap-3">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="bg-white rounded-[24px] p-6 lg:p-8 border border-slate-100 shadow-sm shadow-slate-200/50">
          ...
          {deal.notes ? (
            <p className="text-sm text-slate-600 leading-relaxed whitespace-pre-wrap">{deal.notes}</p>
          ) : (
      ...
      {showLostModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative bg-white rounded-[24px] p-8 w-full max-w-md shadow-2xl">
            <h3 className="text-lg font-bold text-slate-900 mb-2">Mark Deal as Lost</h3>
            <p className="text-sm text-slate-500 mb-6">
              Why was <span className="font-medium text-slate-700">{deal.title}</span> lost?
            </p>
            <textarea
  ...
  return (
    ...
    >
      <div className="flex justify-between items-start">
        ...
        {Icon && (
          <div className={`w-8 h-8 rounded-full flex items-center justify-center ${accent ? "bg-white/20" : highlight ? "bg-amber-100" : "bg-slate-50 text-slate-400"}`}>
            <Icon className="w-4 h-4" />
          </div>
        )}
      </div>
      <div>
        <span className={`text-lg font-bold ${accent ? "text-white" : highlight ? "text-amber-700" : "text-slate-900"}`} suppressHydrationWarning>
          {value}
        </span>
