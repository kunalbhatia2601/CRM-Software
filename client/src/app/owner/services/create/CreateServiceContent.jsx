...
import { createService } from "@/actions/services.action";
...
export default function CreateServiceContent() {
  ...
  const handleSubmit = async (e) => {
    ...
    startTransition(async () => {
      ...
      if (result.success) {
        ...
        setTimeout(() => {
          router.push(`/owner/services/${result.data.id}`);
        }, 500);
      } else {
        showToast("error", result.error || "Failed to create service.");
      }
    });
  };
  ...
  return (
    <div className="flex flex-col gap-6 w-full max-w-4xl">
      ...
      <PageHeader
        title="New Service"
        description="Create a new service offering for your agency."
