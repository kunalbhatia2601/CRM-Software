...
export default function AccountMeetingsContent({ initialData }) {
  ...
  return (
    <div className="p-6 space-y-6">
      <div>
        ...
        <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">Meetings for your managed projects.</p>
      </div>
                  ...
                  <div className="flex items-start gap-3 flex-1 min-w-0">
                    ...
                    <div className="min-w-0">
                      ...
                      <div className="flex flex-wrap items-center gap-2 mt-1">
                        ...
                        {meeting.project && <span className="text-xs text-slate-400">{meeting.project.name}</span>}
                      </div>
                    </div>
                  </div>
