...
import { createSample } from "@/actions/samples.action";
...
export default function CreateSampleContent() {
  ...
  const handleSubmit = async (e) => {
    ...
    startTransition(async () => {
      ...
      if (result.success) {
        showToast("success", "Sample created successfully!");
        setTimeout(() => {
          router.push(`/sales/samples/${result.data.id}`);
        }, 500);
      } else {
        showToast("error", result.error || "Failed to create sample.");
      }
    });
  };
  ...
  return (
    <div className="flex flex-col gap-6 w-full max-w-4xl">
      ...
      <PageHeader
        title="New Sample"
        description="Create a new work sample for your portfolio."
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <SettingsCard
          title="Links"
          description="Add links or upload files for this sample. At least one link is required."
        >
