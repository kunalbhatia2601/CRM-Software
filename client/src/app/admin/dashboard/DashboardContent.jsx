      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6">
        ...
        <div className="col-span-1 md:col-span-2 bg-white dark:bg-slate-950 rounded-[24px] p-6 border border-slate-100 dark:border-slate-800 shadow-sm dark:shadow-none shadow-slate-200/50 dark:shadow-none flex flex-col">
          <div className="flex justify-between items-start mb-6">
            ...
            <button onClick={() => router.push("/admin/leads")} className="w-8 h-8 rounded-full bg-slate-800 text-white flex items-center justify-center hover:bg-slate-900 transition-colors cursor-pointer">
              <ArrowUpRight className="w-4 h-4" />
            </button>
          </div>
        ...
        <div className="col-span-1 md:col-span-2 bg-white dark:bg-slate-950 rounded-[24px] p-6 border border-slate-100 dark:border-slate-800 shadow-sm dark:shadow-none shadow-slate-200/50 dark:shadow-none flex flex-col">
          <div className="flex justify-between items-start mb-6">
            ...
            <button onClick={() => router.push("/admin/deals")} className="w-8 h-8 rounded-full bg-slate-800 text-white flex items-center justify-center hover:bg-slate-900 transition-colors cursor-pointer">
              <ArrowUpRight className="w-4 h-4" />
            </button>
          </div>
        ...
        <div className="col-span-1 md:col-span-2 bg-white dark:bg-slate-950 rounded-[24px] p-6 border border-slate-100 dark:border-slate-800 shadow-sm dark:shadow-none shadow-slate-200/50 dark:shadow-none">
          <div className="flex justify-between items-center mb-4">
            ...
            <button onClick={() => router.push("/admin/leads")} className="text-xs font-medium text-indigo-600 hover:text-indigo-700 transition-colors cursor-pointer">
              View All →
            </button>
          </div>
        ...
        <div className="col-span-1 md:col-span-2 bg-white dark:bg-slate-950 rounded-[24px] p-6 border border-slate-100 dark:border-slate-800 shadow-sm dark:shadow-none shadow-slate-200/50 dark:shadow-none">
          <div className="flex justify-between items-center mb-4">
            ...
            <button onClick={() => router.push("/admin/deals")} className="text-xs font-medium text-indigo-600 hover:text-indigo-700 transition-colors cursor-pointer">
              View All →
            </button>
          </div>
